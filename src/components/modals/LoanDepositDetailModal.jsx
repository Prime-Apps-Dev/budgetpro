...
/**
 * Модальное окно для отображения деталей финансового продукта (кредита или депозита).
 * Включает статистику, кнопки действий и историю операций.
...
const LoanDepositDetailModal = () => {
  ...
  /**
   * Рассчитывает прогресс погашения кредита в процентах.
  ...
  /**
   * Рассчитывает прогресс роста депозита в процентах.
   * @returns {number} - Прогресс в процентах.
   */
  ...
  /**
   * Рассчитывает количество оставшихся месяцев по кредиту.
   * @returns {number} - Количество оставшихся месяцев.
   */
  ...
  /**
   * Возвращает отфильтрованный список транзакций, относящихся к текущему продукту.
  ...
  /**
   * Обрабатывает внесение планового платежа по кредиту.
   */
  ...
  /**
   * Обрабатывает снятие средств с депозита.
   */
  ...
  /**
   * Переключает на модальное окно редактирования продукта.
   */
  const handleEdit = () => {
  ...
  /**
   * Обрабатывает удаление финансового продукта.
   */
  const handleDelete = () => {
  ...
  /**
   * Закрывает модальное окно деталей.
   */
  const handleClose = () => {
    setSelectedFinancialItem(null);
  };
        ...
        <AnimatePresence>
          {showEarlyRepaymentModal && (
            <ModalWrapper
              ...
              handleClose={() => setShowEarlyRepaymentModal(false)}
            >
